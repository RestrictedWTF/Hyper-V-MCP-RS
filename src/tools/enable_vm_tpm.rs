...
#[async_trait]
impl HyperVTool for EnableVmTpmTool {
    const NAME: &'static str = "hyperv_enable_vm_tpm";
    const DESCRIPTION: &'static str = "Enables TPM functionality on a virtual machine.";
    type Input = EnableVmTpmInput;
    type Output = EnableVmTpmOutput;
