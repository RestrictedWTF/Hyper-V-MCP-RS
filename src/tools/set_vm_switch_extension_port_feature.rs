...
pub struct SetVmSwitchExtensionPortFeatureInput {
    /// ID of the feature.
    #[serde(rename = "featureId")]
    pub feature_id: String,
    /// Name of the VM network adapter.
    #[serde(rename = "vmNetworkAdapter")]
    pub vm_network_adapter: String,
    /// Configuration data.
...
#[derive(Debug, Serialize, JsonSchema)]
pub struct SetVmSwitchExtensionPortFeatureOutput {
...
#[async_trait]
impl HyperVTool for SetVmSwitchExtensionPortFeatureTool {
    const NAME: &'static str = "hyperv_set_vm_switch_extension_port_feature";
    const DESCRIPTION: &'static str = "Configures a feature on a virtual network adapter.";
    type Input = SetVmSwitchExtensionPortFeatureInput;
    type Output = SetVmSwitchExtensionPortFeatureOutput;
