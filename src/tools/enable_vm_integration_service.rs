...
pub struct EnableVmIntegrationServiceInfo {
    pub name: String,
    pub id: String,
    pub state: String,
    pub uptime: String,
...
pub struct EnableVmIntegrationServiceInput {
    /// Name of the virtual machine.
    #[serde(rename = "vmName")]
    pub vm_name: String,
    /// Name of the integration service to enable.
pub name: String,
...
#[derive(Debug, Serialize, JsonSchema)]
pub struct EnableVmIntegrationServiceOutput {
    pub vms: Vec<EnableVmIntegrationServiceInfo>,
}


#[derive(Default)]
pub struct EnableVmIntegrationServiceTool;

#[async_trait]
impl HyperVTool for EnableVmIntegrationServiceTool {
    const NAME: &'static str = "hyperv_enable_vm_integration_service";
    const DESCRIPTION: &'static str = "Enables an integration service on a virtual machine.";
    type Input = EnableVmIntegrationServiceInput;
    type Output = EnableVmIntegrationServiceOutput;

    async fn run(&self, ctx: &ToolContext, input: Self::Input) -> Result<Self::Output, ToolError> {
        let mut args = vec!["Enable-VMIntegrationService".to_string()];
        ...
        for vm in vms {
            output.push(EnableVmIntegrationServiceInfo {
        ...
        Ok(EnableVmIntegrationServiceOutput { vms: output })
    }
}

register_tool!(EnableVmIntegrationServiceTool);
