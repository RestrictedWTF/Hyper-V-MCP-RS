...
pub struct GetVmKeyProtectorInput {
...
#[derive(Debug, Serialize, JsonSchema)]
pub struct GetVmKeyProtectorOutput {
...
#[async_trait]
impl HyperVTool for GetVmKeyProtectorTool {
    const NAME: &'static str = "hyperv_get_vm_key_protector";
    const DESCRIPTION: &'static str = "Retrieves a key protector for a virtual machine.";
    type Input = GetVmKeyProtectorInput;
    type Output = GetVmKeyProtectorOutput;
