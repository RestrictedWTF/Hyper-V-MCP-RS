...
pub struct GetVmSwitchExtensionSwitchFeatureInput {
    /// ID of the feature.
...
#[derive(Debug, Serialize, JsonSchema)]
pub struct GetVmSwitchExtensionSwitchFeatureOutput {
    pub data: Vec<VmSwitchExtensionSwitchDataInfo>,
}


#[derive(Default)]
pub struct GetVmSwitchExtensionSwitchFeatureTool;

#[async_trait]
impl HyperVTool for GetVmSwitchExtensionSwitchFeatureTool {
    const NAME: &'static str = "hyperv_get_vm_switch_extension_switch_feature";
    const DESCRIPTION: &'static str = "Gets the features configured on a virtual switch.";
    type Input = GetVmSwitchExtensionSwitchFeatureInput;
    type Output = GetVmSwitchExtensionSwitchFeatureOutput;

    async fn run(&self, ctx: &ToolContext, input: Self::Input) -> Result<Self::Output, ToolError> {
        let mut args = vec!["Get-VMSwitchExtensionSwitchFeature".to_string()];
        ...
        Ok(GetVmSwitchExtensionSwitchFeatureOutput { data: output })

    }
}


register_tool!(GetVmSwitchExtensionSwitchFeatureTool);
