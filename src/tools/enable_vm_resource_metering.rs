...
pub struct EnableVmResourceMeteringInfo {
    pub name: String,
    pub id: String,
    pub state: String,
    pub uptime: String,
...
pub struct EnableVmResourceMeteringInput {
...
#[derive(Debug, Serialize, JsonSchema)]
pub struct EnableVmResourceMeteringOutput {
...
impl HyperVTool for EnableVmResourceMeteringTool {
    ...
    async fn run(&self, ctx: &ToolContext, input: Self::Input) -> Result<Self::Output, ToolError> {
        ...
        for vm in vms {
            output.push(EnableVmResourceMeteringInfo {
...
register_tool!(EnableVmResourceMeteringTool);
