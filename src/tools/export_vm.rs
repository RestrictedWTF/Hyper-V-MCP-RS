...
pub struct ExportVmInput {
    /// Name of the virtual machine.
    #[serde(rename = "vmName")]
    pub vm_name: String,
    /// Path to export the virtual machine to.
    #[serde(rename = "path")]
    pub path: String,
...
#[async_trait]
impl HyperVTool for ExportVmTool {
    const NAME: &'static str = "hyperv_export_vm";
    const DESCRIPTION: &'static str = "Exports a virtual machine to disk.";
    type Input = ExportVmInput;
    type Output = ExportVmOutput;
